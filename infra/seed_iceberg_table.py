...
def main():
    ...
    print("Created table: test_db.orders")
    ...
    table.append(batch1)
    print("  Snapshot 1: 5 rows (initial batch)")
    ...
    table.append(batch2)
    print("  Snapshot 2: 5 more rows (second batch)")
    ...
    batch3 = pa.table(
        {
            ...
            "created_at": pa.array(
                [
                    ts("2025-03-01T09:00:00"),
                    ts("2025-03-02T11:30:00"),
                    ts("2025-03-03T14:00:00"),
                ],
                type=pa.timestamp("us"),
            ),
        },
    ...
    table.append(batch3)
    print("  Snapshot 3: 3 more rows (third batch)")
